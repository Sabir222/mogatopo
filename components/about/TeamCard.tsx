  ...
  return (
    <div>
      <div className="flex-1 bg-blue-500 relative h-[500px] group overflow-hidden">
        <Image
          src="https://plus.unsplash.com/premium_photo-1681992176004-1117a54ef306?q=80&w=1925&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
          height={500}
          width={1000}
